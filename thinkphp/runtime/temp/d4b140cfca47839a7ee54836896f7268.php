<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"C:\thinkphp/application/platform\view\show\show1.html";i:1526823252;s:54:"C:\thinkphp/application/platform\view\public\head.html";i:1529569052;s:54:"C:\thinkphp/application/platform\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
	...
	layui.use(['laydate','form'], function(){
      ...
      function delAll () {
        ...
        layer.confirm('确认删除这'+len.toString()+'条数据吗？',function(index){
			...
			for(i=0;i<len;i++)
			{
            $.post("<?php echo url('platform/deletedatas/deletesensordatas'); ?>", {datas: datas[i]}, function(data, textStatus, xhr) {
