<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"C:\thinkphp/application/newdata\view\index\sensor.html";i:1525443734;s:53:"C:\thinkphp/application/newdata\view\public\head.html";i:1528618687;s:53:"C:\thinkphp/application/newdata\view\public\foot.html";i:1525359662;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <div class="page_nav">
      <span>您的位置:</span> <a href="<?php echo url('newdata/user/index'); ?>">数据中心</a> <span><i class="fa fa-angle-double-right"></i>Sensor</span>
      </div>
      </div>
    </div>
  </div>
...
<table class="layui-table">
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        	<tr>
	            ...
	            <td><?php echo $vo['nodenum']; ?></td>
	            <td><p><?php echo $vo['temperature']; ?>℃</p></td>
                <td><p><?php echo $vo['humidity']; ?>%</p></td>
	            <td><p><?php echo $vo['light']; ?>lx</p></td>
	            <td><p><?php echo $vo['air']; ?>ppm</p></td>
