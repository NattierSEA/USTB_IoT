<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:48:"C:\thinkphp/application/admin\view\user\add.html";i:1528637582;s:51:"C:\thinkphp/application/admin\view\public\head.html";i:1515723186;s:51:"C:\thinkphp/application/admin\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body" >
	<form class="layui-form" id='mainForm' method="post" action="addUser">
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    <input type="text" id="email" name="email"  placeholder="请输入注册邮箱" autocomplete="off" class="layui-input">
		    </div>
		</div>
