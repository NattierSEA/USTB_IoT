<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"C:\thinkphp/application/admin\view\index\index.html";i:1544602241;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              <dd><a href="<?php echo url('platform/user/index'); ?>">开发者平台</a></dd>
              <dd><a href="<?php echo url('admin/user/logout'); ?>">切换帐号</a></dd>
