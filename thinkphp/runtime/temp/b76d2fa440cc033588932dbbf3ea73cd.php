<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"C:\thinkphp/application/platform\view\device\deviceedit.html";i:1530703314;s:54:"C:\thinkphp/application/platform\view\public\head.html";i:1529569052;s:54:"C:\thinkphp/application/platform\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body" >
	<form class="layui-form" id='mainForm' method="post" action="<?php echo url('device/editsubmit'); ?>">
		...
		<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select  value="<?php echo $devicedata['tid']; ?>"  name="tid" id='tid' multiple="multiple">
                        <?php 
