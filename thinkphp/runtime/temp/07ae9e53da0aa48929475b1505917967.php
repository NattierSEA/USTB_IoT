<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"C:\thinkphp/application/download\view\index\index.html";i:1525922900;s:54:"C:\thinkphp/application/download\view\public\head.html";i:1544601714;s:54:"C:\thinkphp/application/download\view\public\foot.html";i:1544601774;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <p>作者以往开发的软件提供免费下载。</p>
        <div class="page_nav">
      <span>您的位置:</span> <a href="<?php echo url('download/index/index'); ?>">下载中心</a> <span><i class="fa fa-angle-double-right"></i>主页</span>
      </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-9">
        <article class="blog_item heading_space wow fadeInLeft" data-wow-delay="300ms">
          <div class="row">
            <div class="col-md-5 col-sm-5 heading_space">
              <div class="image"><img src="__static__\dpicture\cktszsbkb.jpg" alt="blog" class="border_radius"></div>
            </div>
            <div class="col-md-7 col-sm-7 heading_space">
              <h2>WPF桌面软件</h2>
              <ul class="comment margin10">
                <li><a href="">2017.07-2018.04</a></li>
                <li><a href="">研发</a></li>
              </ul>
              <p class="margin10">包含串口调试助手等常用软件，使用C#开发，具有很强大的可扩展性，可以根据需求快速定制。
              </p>
              <a class=" btn_common btn_border margin10 border_radius" href="<?php echo url('download/index/windows'); ?>">进入</a>
            </div>
          </div>
        </article>
        <article class="blog_item heading_space wow fadeInLeft" data-wow-delay="400ms">
          <div class="row">
            <div class="col-md-5 col-sm-5 heading_space">
              <div class="image"><img src="__static__\dpicture\nattierseaandroid.jpg" alt="blog" class="border_radius"></div>
            </div>
            <div class="col-md-7 col-sm-7 heading_space">
              <h2>Android APP</h2>
              <ul class="comment margin10">
              ...
              <p class="margin10">蓝牙和网络传输，是物联网安卓项目开发的重点。在这里有两个简单的实例。
			  </p>
              <a class=" btn_common btn_border margin10 border_radius" href="<?php echo url('download/index/android'); ?>">进入</a>
            </div>
          </div>
        </article>
      </div>
