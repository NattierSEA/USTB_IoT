<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"C:\thinkphp/application/course\view\index\course2.html";i:1533282038;s:52:"C:\thinkphp/application/course\view\public\head.html";i:1544601894;s:52:"C:\thinkphp/application/course\view\public\foot.html";i:1544601926;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
      <div class="col-sm-6 col-md-4">
        <div class="course margin_top wow fadeIn" data-wow-delay="400ms">
          ...
          <h3 class="bottom10"><a href="<?php echo url('course/index/study2?course='.$v['id']); ?>"><?php echo $v['name']; ?></a></h3>
          <p class="bottom20" style="height:120px"><?php echo $v['brief']; ?></p>
          <a class="btn_common yellow border_radius" href="<?php echo url('course/index/study2?course='.$v['id']); ?>">学习</a>
        </div>
      </div>
