<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:54:"C:\thinkphp/application/course\view\index\course1.html";i:1533282116;s:52:"C:\thinkphp/application/course\view\public\head.html";i:1544601894;s:52:"C:\thinkphp/application/course\view\public\foot.html";i:1544601926;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>物联网实验箱教学视频</h1>
        <p>包含超过200课时学习视频，内容涵盖实验箱配置的二十多种传感器，三种执行器以，三种识别模块以及其中其中无线传输模块的实验，网关及终端的实验应有尽有。</p>
        <div class="page_nav">
      <span>您的位置:</span> <a href="<?php echo url('course/index/index'); ?>">视频课程中心</a> <span><i class="fa fa-angle-double-right"></i><a href="<?php echo url('course/index/course1'); ?>">物联网实验箱教学视频</a> </span>
      </div>
      </div>
    </div>
  </div>
	...
	<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
      <div class="col-sm-6 col-md-4">
        <div class="course margin_top wow fadeIn" data-wow-delay="400ms">
          ...
          <h3 class="bottom10"><a href="<?php echo url('course/index/study1?course='.$v['id']); ?>"><?php echo $v['name']; ?></a></h3>
          <p class="bottom20" style="height:120px"><?php echo $v['brief']; ?></p>
          <a class="btn_common yellow border_radius" href="<?php echo url('course/index/study1?course='.$v['id']); ?>">学习</a>
        </div>
      </div>
