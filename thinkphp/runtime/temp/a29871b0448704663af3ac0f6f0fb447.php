<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\thinkphp/application/platform\view\application\addapplication.html";i:1527650636;s:54:"C:\thinkphp/application/platform\view\public\head.html";i:1529569052;s:54:"C:\thinkphp/application/platform\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body" >
	<form class="layui-form" id='mainForm' method="post" action="<?php echo url('application/addapp'); ?>">
		...
		<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="connect" id='connect'  multiple="multiple">
                         <?php if(is_array($connect) || $connect instanceof \think\Collection || $connect instanceof \think\Paginator): $i = 0; $__LIST__ = $connect;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
