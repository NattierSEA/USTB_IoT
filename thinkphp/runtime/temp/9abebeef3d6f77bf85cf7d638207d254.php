<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"C:\thinkphp/application/data\view\index\bd.html";i:1525247941;}*/ ?>
﻿<!DOCTYPE html>
...
<script src="__js__/mediaelement-and-player.min.js"></script>
  ...
  <div id="ajaxContent">
    <form action="clear.php" method="POST">
     ...
     <div id="container"></div>
      ...
      $sql = "SELECT * FROM nbbd ORDER BY device ASC,id DESC";
      ...
      {
			$time  = $newArray['time'];
			$device = $newArray['device'];
			$latitude = $newArray['latitude'];
			$longitude = $newArray['longitude'];
			$temperature = $newArray['temperature'];
			$humidity = $newArray['humidity'];
			$ns = $newArray['ns'];
			$ew = $newArray['ew'];
            if($device != $Nownode && $Nownode != ""){
            echo '</table><hr color="#666666" >';
            }
            if($device != $Nownode){
            $Nownode=$device;
            echo '<table cellspacing="0" border="0" width="100%" bordercolor="#000000" align="center"><tr align="center"><td width="20%">'.$device.'终端</td><td width="20%">时间</td><td width="20%">经度</td><td width="20%">纬度</td><td width="10%">温度</td><td width="10%">湿度</td>></tr>';
            }
			echo "<tr align=\"center\"><td></td><td>".$time."</td><td>".$longitude.$ew."</td><td>".$latitude.$ns."</td><td>".$temperature."℃</td><td>".$humidity."%</td></tr>";
       }
            echo "</table>";
       } 
    ...
    <hr color="#666666" >
		...
		<div class="homeslider row">        
            <div class="flexslider clearfix">
                <ul class="slides">
                    <li><img src="images/p1.jpg" alt="" /><div class="flex-caption"></div></li>
                    <li><img src="images/p2.jpg" alt="" /><div class="flex-caption"></div></li>
                    <li><img src="images/p3.jpg" alt="" /><div class="flex-caption"></div></li>
                </ul>
            </div>
