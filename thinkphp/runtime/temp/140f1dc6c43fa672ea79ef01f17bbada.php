<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"C:\thinkphp/application/download\view\index\android.html";i:1525922826;s:54:"C:\thinkphp/application/download\view\public\head.html";i:1544601714;s:54:"C:\thinkphp/application/download\view\public\foot.html";i:1544601774;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>Android APP</h1>
        <p>基于Android系统的APP，可运行于手机、平板等设备上。系统最低要求为Android 4.0。</p>
        <div class="page_nav">
      <span>您的位置:</span> <a href="<?php echo url('download/index/index'); ?>">下载中心</a> <span><i class="fa fa-angle-double-right"></i>Android</span>
      </div>
      </div>
    </div>
  </div>
	...
	<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
      <div class="col-sm-6 col-md-4">
        <div class="course margin_top wow fadeIn" data-wow-delay="400ms">
          ...
          <h3 class="bottom10"><a href="<?php echo url('download/index/downloads?fileid='.$v['name']); ?>"><?php echo $v['name']; ?></a></h3>
          <p class="bottom20" style="height:120px"><?php echo $v['brief']; ?></p>
          <a class="btn_common yellow border_radius" href="<?php echo url('download/index/downloads?fileid='.$v['name']); ?>">下载</a>
        </div>
      </div>
