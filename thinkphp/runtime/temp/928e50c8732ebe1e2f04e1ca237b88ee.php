<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"C:\thinkphp/application/platform\view\show\show3.html";i:1526807770;s:54:"C:\thinkphp/application/platform\view\public\head.html";i:1529569052;s:54:"C:\thinkphp/application/platform\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<div class="x-body" style="width:70%; margin: 0 auto">
        ...
        <?php if(is_array($datas) || $datas instanceof \think\Collection || $datas instanceof \think\Paginator): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        	<tr>
	            ...
	            <td><p><?php echo $vo['temp']; ?>℃</p></td>
	            <td><p><?php echo $vo['hum']; ?>%</p></td>
	...
	<script>
      ...
      function delAll () {
        ...
        layer.confirm('确认删除这'+len.toString()+'条数据吗？',function(index){
			...
			for(i=0;i<len;i++)
			{
            $.post("<?php echo url('platform/deletedatas/deletedatas3'); ?>", {datas: datas[i]}, function(data, textStatus, xhr) {
	  ...
	  function delData(obj,id){
        ...
        layer.confirm('确认要删除吗？',function(index){
            //捉到所有被选中的，发异步进行删除
            $.post("<?php echo url('platform/deletedatas/deletedata3'); ?>", {id: id}, function(data, textStatus, xhr) {
          /*optional stuff to do after success */
              console.log(data);
              if(data.code==1){
                  layer.msg(data.msg,{icon:1,time:1000},function(){
