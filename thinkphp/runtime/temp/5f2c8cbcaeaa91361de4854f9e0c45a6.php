<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"C:\thinkphp/application/admin\view\user\userlist.html";i:1525674566;s:51:"C:\thinkphp/application/admin\view\public\head.html";i:1515723186;s:51:"C:\thinkphp/application/admin\view\public\foot.html";i:1515723186;}*/ ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <meta name="renderer" content="webkit|ie-comp|ie-stand">
    ...
    <div class="x-body">
       <!--<button class="layui-btn  layui-btn-small layui-btn-danger" onclick="delAll()">批量删除</button>-->
        ...
        <span class="x-right" style="line-height:40px">共有用户:<i class="i_count"><?php echo $users->total(); ?></i>位</span>
